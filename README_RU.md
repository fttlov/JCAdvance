...
JCAdvance не просто делает фокус на удобстве взаимодействия с Joy-con, но и даёт возможность гибкой настройки работы гироскопа для различных устройств (Gyro Space). Убеждён, что в этом аспекте классические двуручные контроллеры и Joy-con'ы имеют различную концепцию применения: <br>

* **Двуручные**: Gyro Motion используется для доводки при прицеливании, дополняя классический looking/aiming на стике <br>
* **Joy-con'ы** - это свободные руки, иные степени свободы, полноценное использование гироскопа для обзора/прицеливания в FPS TPS играх без использования стика. *И как следствие, мы получаем свободный правый стик и*:<br>
* **SixAxis для Joy-con** - Возможность использовать ось Y стика (вверх/вниз) для управления аналоговыми триггерами виртуального контроллера одновременно с обычными цифровыми триггерами ZL ZR. Функция контролируется (вкл./выкл.) настаиваемой горячей клавишей.<br>

Примеры использования:<br>
- RDR2: медленно потяните правый стик вверх, чтобы заполнить индикатор в дуэлях (позволяет обойти проблему с цифровым триггером); плавно взведите курок револьвера и выстрелите или просто ведите огонь с помощью цифрового триггера ZR.
...
- Клавиша управления гироскопом для запуска/приостановки отслеживания движения нажатием назначенной кнопки
...
## Важно!
Некоторые игры, а также Steam Input не будут работать корректно из-за проблемы двойного ввода - одновременной инициализации реального геймпада и виртуального.
...
- Добавлен прикольный Gyro жест "рукопашная". Удобен для Joy-con. Можно жестом удара руки (прямой, боковой) или удара молотком эмулировать любую кнопку Xbox, клавиатуры/мыши. То есть Melee atack в игре не занимает физическую кнопку. 
