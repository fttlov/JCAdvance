...
* **Joy-con'ы** - это свободные руки, иные степени свободы, полноценное использование гироскопа для обзора/прицеливания в FPS TPS играх без использования стика вообще, *и как следствие*:<br>
