...
- Полностью настраиваемые горячие клавиши для различных Gyro режимов с поддержкой комбинаций клавиш (например: R+HOME)
- Опция Gyro Space для тонкой настройки работы гироскопа для различных геймпадов (см. раздел техническая информация) <br>
