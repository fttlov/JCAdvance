...
- New Gyro Melee gesture for joy-cons. Map virtual button to a punch, hook, blow hammer gesture
- Спецдвижения: привяжите виртуальную кнопку геймпада к жесту удара рукой; отдельная настройка сила удара 
...
- (Экспериментально) Теперь поддерживаются любые Dinput рули/педали (см. технический раздел)
...
🌐 Worldwide:<br>👉 **[Donationalerts](https://dalink.to/fttlov)** <table align="center">
<details>
  <summary>📷 QR code </summary>
