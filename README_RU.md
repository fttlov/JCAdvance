...
* **SixAxis для Joy-con** - возможность использовать ось Y стика (вверх/вниз) для управления аналоговыми триггерами виртуального контроллера. Работает одновременно с обычными цифровыми кнопками, уже назанченными как тригерры (напримерZL ZR). Функция контролируется (вкл./выкл.) настаиваемой горячей клавишей.<br>
