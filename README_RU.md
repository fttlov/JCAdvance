...
## Возможные проблемы:
- Congfig.exe написан на AHK  и может быть немного капризен к DPI в Windows. Если текст не влезает в окно или наклдывается друг на друга, временно уменьшите значение DPI или смените разрешение экрана
