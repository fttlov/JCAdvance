...
I assume that Gyro aiming with a two-handed gamepad and with Joy-Cons is based on different concepts. Two handed: "Fine-tuning", adjustment by gyro for classic aiming. Joy-con's - free hand full Gyro aiming.
...
<sub>For Sony gamepads you can do the same, but wihou GUI by editing Default.ini in \XboxProfile</sub>
