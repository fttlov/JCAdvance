...
* **JCAdvance allows you to use the right stick's Y-axis as analog triggers** alongside (simultaneously) your physical digital ZL/ZR buttons. This feature can be fully controlled (enabled/disabled) in real time using a customisable hotkey.<br>
