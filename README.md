...
To prevent this, we recommend using the [HidHide](https://github.com/nefarius/HidHide) utility by nefarius.<details>
  <summary><h4>Setup</h4> (Click to open)</summary>
 Download and install HidHide. Open HidHide Configuration Client and:

1. Add JCAdvance.exe and Config.exe
 
2. Tick your gamepad
 
3. Tick enable device hiding
 <table align="center">
  <tr>
